...
public class InGame1_Turn_GameSet : State<InGame1>
{
    ...
    public override void Enter() // ResultPopup을 띄웁니다.
    {
        ...
        {
            canvas.SetUIPanel<InGame1UI_ResultPopup>(new ResultUIParam("삼촌", Uncle));
        }
        else
        {
            canvas.SetUIPanel<InGame1UI_ResultPopup>(new ResultUIParam("조카", Nephew));
        }
